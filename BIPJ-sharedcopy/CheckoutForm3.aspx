<%@ Page Title="" Language="C#" MasterPageFile="~/NewSite.Master" AutoEventWireup="true" CodeBehind="CheckoutForm3.aspx.cs" Inherits="BIPJ_sharedcopy.CheckoutForm3" %>
      ...
      initPayPalButton();
        ...
        <tr>
            ...
            <td class="auto-style11">
                <br />
            &nbsp;
                <asp:Button ID="btn_ConfirmPurchase3" OnClick="btn_ConfirmPurchase3_Click" runat="server" Text="Confirm Purchase" Width="182px" /> &nbsp; &nbsp; 
                &nbsp; &nbsp;&nbsp;&nbsp;
                <br />
