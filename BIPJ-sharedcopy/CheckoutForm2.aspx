<%@ Page Title="" Language="C#" MasterPageFile="~/NewSite.Master" AutoEventWireup="true" CodeBehind="CheckoutForm2.aspx.cs" Inherits="BIPJ_sharedcopy.CheckoutForm2" %>
      ...
      initPayPalButton();
        ...
        <tr>
            ...
            <td class="auto-style11">
                <br />
            &nbsp;
                <asp:Button ID="btn_ConfirmPurchase2" OnClick="btn_ConfirmPurchase2_Click" runat="server" Text="Confirm Purchase" Width="182px" /> &nbsp; &nbsp; 
                &nbsp; &nbsp;&nbsp;&nbsp;
                <br />
